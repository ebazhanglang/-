  ...
  <div class="user-info">
    ...
    <el-form label-width="220px">
      ...
      <el-row class="inline-info">
        <el-col :span="12">
          <el-form-item label="员工头像">
            <!-- 放置上传图片 -->
            <uploadImg ref="Avataro" :employees-avatar="employeesAvatar" @on-success="uploadAvatar" />
          </el-form-item>
        </el-col>
      </el-row>
      <!-- 保存个人信息 -->
      <el-row class="inline-info" type="flex" justify="center">
        <el-col :span="12">
          <el-button type="primary" @click="saveUserDetailById">保存更新</el-button>
    ...
    <el-form label-width="220px">
      <div class="block">
        ...
        <el-form-item label="员工照片">
          <!-- 放置上传图片 -->
          <uploadImg ref="userPic" :employees-avatar="employeesPic" @on-success="uploadPic" />
        </el-form-item>
...
import { getEmployeeInfoAPI, saveEmployeesInfo } from '@/api/EmployeeSimple'
export default {
  data() {
    return {
      name: 'userinfo',
  ...
  methods: {
    ...
    async saveEmployeesInfo() {
      try {
        if (this.$refs.userPic.loading) {
          return this.$message.error('头像正在更新中')
        }
